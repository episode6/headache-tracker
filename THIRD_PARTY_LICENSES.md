...
Headache Tracker is built with the third-party components below. This document is
also compiled into the app and shown on its license-notices screen (Settings →
Third-party license notices).
...
- **Kotlin** standard library, **kotlin-reflect**, and the **kotlinx** libraries
